...
ERRORS: dict[str, tuple[str, str]] = {
    ...
    "E_OBJECT_NOT_FOUND": ("No object with that id in this investigation.", "`rb status` lists every question, hypothesis, experiment, claim, evidence and decision id."),
    ...
    "E_FROZEN": ("The experiment is frozen, and this would change its spec (a knob's value, a claim's criterion).", "Pass --amend \"<reason>\" to change it anyway; the change, the reason and the spec hash before and after are kept. Amending is a person's call."),
    ...
    "E_SOURCE_UNRESOLVED": ("The source was read and does not state the value, or could not be read.", "The knob stays inferred. Check the path, line, quote or commit, or set the value the source actually states: `rb knob set <exp> <name> <value> --source <file:line>`."),
